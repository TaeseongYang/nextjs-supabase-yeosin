...
export const dummyReviews: Review[] = [
  ...
  },
  {
    ...
    authorLabel: "송**",
    rating: 5,
    content: "여러 번 받으니 확실히 털이 얇아지고 나는 속도도 느려졌어요.",
  ...
  },
  {
    ...
    authorLabel: "배**",
    rating: 4,
    content: "부분 제모라 시술 시간이 짧고 통증도 견딜만했어요.",
    createdAt: "2026-07-01",
    attributeTags: ["pain", "effect"],
  },
  {
    id: "rev-19",
    productId: "prod-17",
    authorLabel: "노**",
    rating: 3,
    content: "가격은 합리적인데 원하는 효과를 보려면 재방문이 꽤 필요했어요.",
    createdAt: "2026-07-03",
    attributeTags: ["price", "effect"],
  },
  {
    id: "rev-20",
    productId: "prod-17",
    authorLabel: "홍**",
    rating: 5,
    content: "상담부터 시술까지 설명이 자세해서 안심하고 받을 수 있었어요.",
    createdAt: "2026-07-05",
    attributeTags: ["medical_staff", "service"],
  },
  {
    id: "rev-21",
    productId: "prod-18",
    authorLabel: "유**",
    rating: 5,
    content: "니들 제모라 확실히 재발이 적다고 느꼈고 관리도 꼼꼼했어요.",
    createdAt: "2026-07-06",
    attributeTags: ["effect", "medical_staff"],
  },
  {
    id: "rev-22",
    productId: "prod-18",
    authorLabel: "구**",
    rating: 3,
    content: "효과는 좋지만 시술 부위가 며칠 동안 붉어져서 불편했어요.",
